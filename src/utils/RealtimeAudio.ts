...
export class RealtimeChat {
  ...
  async init() {
    try {
      ...
      if (error) {
        console.error("[RealtimeChat] Error getting session:", error);
        throw error;
      }

      console.log("[RealtimeChat] Session data received:", data);
      ...
      // Set up remote audio
      this.pc.ontrack = e => {
        console.log("[RealtimeChat] Received remote audio track");
